      ...
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
        <div class="relative overflow-x-auto rounded-lg overflow-hidden">
          <table class="min-w-full">
            <thead class="bg-white dark:bg-slate-800 border-b border-b">
              <tr class="">
            ...
            <tbody>
              @foreach ($data[0]->siswa as $siswa)
                <tr
                  class="bg-white dark:bg-slate-800 dark:border-b-0 border-b transition duration-300 ease-in-out hover:bg-gray-100 dark:hover:bg-slate-700">
